...
namespace LIVE_DEMO
{
    public class Rasterization
    {
        ...
        public Rasterization(Size size, List<float[]> vertices, List<int[]> triangles, float rotationAngle, float z)
        {
        ...
        private void Init(Size size, float z)
        {
            ...
            instances = new Instance(cube, new Vertex(3f, -2f, 30f), Mtx.RotY(rotationAngle), z);
        ...
        public void Render()
        {
            Mtx rotate = Mtx.RotY(rotationAngle);
